(() => {
  ...
  // src/scripts/animations/introAnimation.js
  var introAnimation = () => {
  ...
  // src/scripts/animations/boxFollowAnimation.js
  var boxFollowAnimation = () => {
    const $mainContainer = document.querySelector("main");
    const $box = $mainContainer.querySelector(".box");
    const animationX = gsapWithCSS.quickTo($box, "x", {
      delay: 0.5,
      duration: 0.4,
      transformOrigin: "center center"
    });
    const animationY = gsapWithCSS.quickTo($box, "y", {
      delay: 0.5,
      duration: 0.4,
      transformOrigin: "center center"
    });
